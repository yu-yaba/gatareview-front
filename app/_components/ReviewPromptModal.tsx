    ...
    >
      <div className="bg-white rounded-3xl p-4 md:p-6 max-w-md w-full mx-4 shadow-2xl border border-gray-100 relative overflow-hidden animate-fade-in max-h-[90vh] overflow-y-auto">
        ...
        <div className="relative z-10">
          ...
          {/* 説明セクション */}
          <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-3 mb-4 border border-gray-200/50">
            <div className="flex items-center justify-center mb-2">
              <FaHeart className="text-gray-600 text-lg mr-2" />
              <h3 className="text-base md:text-lg font-bold text-gray-800">新大生の皆さんがあなたのレビューを待っています！</h3>
            </div>
          </div>
